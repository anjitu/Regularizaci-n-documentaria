...
if not df_evolutivo.empty:
    ...
    fig = px.bar(df_evolutivo, x="FECHA_ARCHIVO", y="TOTAL_PENDIENTES",
                 title="Tendencia de pendientes diarios", labels={"FECHA_ARCHIVO": "Fecha", "TOTAL_PENDIENTES": "Pendientes"})
...
# --- 9. Botón para descargar Excel filtrado ---
...
# --- 10. Botón para descargar Excel evolución ---
excel_evolutivo = to_excel_bytes(df_evolutivo)
st.download_button(
